...
class TextMelLoader(torch.utils.data.Dataset):
    ...
    def get_mel_text_pair(self, audiopath_and_text):
        ...
        # audiopath = "/ssd_scratch/cvit/anchit/faizan/dataset/done/PLbMVogVj5nJTTGvVQL5ks-woI_vqDTKXF/splits/wavs/" + audiopath
        audiopath = self.audio_dir + audiopath
...
class TextMelSpeakerLoader(torch.utils.data.Dataset):
    ...
    def get_mel_text_speaker_pair(self, audiopath_sid_text):
        ...
        audiopath, sid, text = audiopath_sid_text[1], audiopath_sid_text[0], audiopath_sid_text[2]
        audiopath = self.audio_dir + audiopath
        text = self.get_text(text)
        mel = self.get_mel(audiopath)
